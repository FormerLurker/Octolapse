...
class Test_Trigger(unittest.TestCase):
    ...
    def test_IsInPosition_Rect_Forbidden(self):
        ...
        self.assertTrue(trigger.IsInPosition(restrictions, 20.1, 20.1))
        self.assertTrue(trigger.IsInPosition(restrictions, 15, 25))
        self.assertTrue(trigger.IsInPosition(restrictions, 25, 15))

        self.assertFalse(trigger.IsInPosition(restrictions, 10, 10))
        self.assertFalse(trigger.IsInPosition(restrictions, 15, 15))
    ...
    def test_IsInPosition_Rect_Required(self):
        ...
        self.assertFalse(trigger.IsInPosition(restrictions, 15, 25))
        self.assertFalse(trigger.IsInPosition(restrictions, 25, 15))

        self.assertTrue(trigger.IsInPosition(restrictions, 10, 10))
        self.assertTrue(trigger.IsInPosition(restrictions, 15, 15))
        self.assertTrue(trigger.IsInPosition(restrictions, 20, 20))
    ...
    def test_IsInPosition_Rect_ForbiddenAndRequired(self):
        ...
        self.assertFalse(trigger.IsInPosition(restrictions, 0, 0))
        self.assertFalse(trigger.IsInPosition(restrictions, 100, 0))
        self.assertFalse(trigger.IsInPosition(restrictions, 12.5, 25))
        self.assertFalse(trigger.IsInPosition(restrictions, 25, 12.5))

        # test only in forbidden area
        self.assertFalse(trigger.IsInPosition(restrictions, 20.1, 25))
        self.assertFalse(trigger.IsInPosition(restrictions, 20.1, 20.1))
        ...
        self.assertFalse(trigger.IsInPosition(restrictions, 15, 15))
        self.assertFalse(trigger.IsInPosition(restrictions, 20, 20))
        self.assertFalse(trigger.IsInPosition(restrictions, 15, 20))
        self.assertFalse(trigger.IsInPosition(restrictions, 20, 15))
    ...
    def test_IsInPosition_Circle_Forbidden(self):
        ...
        self.assertTrue(trigger.IsInPosition(restrictions, 0, 0))
        self.assertTrue(trigger.IsInPosition(restrictions, 100, 0))
        self.assertTrue(trigger.IsInPosition(restrictions, 9, 9))
        self.assertTrue(trigger.IsInPosition(restrictions, 11, 11))
        self.assertTrue(trigger.IsInPosition(restrictions, 9, 11))
        self.assertTrue(trigger.IsInPosition(restrictions, 11, 9))
        # tests inside forbidden area
        self.assertFalse(trigger.IsInPosition(restrictions, 10, 10))
        self.assertFalse(trigger.IsInPosition(restrictions, 10, 9))
        self.assertFalse(trigger.IsInPosition(restrictions, 9, 10))
        self.assertFalse(trigger.IsInPosition(restrictions, 10, 11))
    ...
    def test_IsInPosition_Circle_Required(self):
        ...
        self.assertFalse(trigger.IsInPosition(restrictions, 0, 0))
        self.assertFalse(trigger.IsInPosition(restrictions, 100, 0))
        self.assertFalse(trigger.IsInPosition(restrictions, 9, 9))
        self.assertFalse(trigger.IsInPosition(restrictions, 11, 11))
        self.assertFalse(trigger.IsInPosition(restrictions, 9, 11))
        ...
        self.assertTrue(trigger.IsInPosition(restrictions, 11, 10))
    ...
    def test_IsInPosition_Circle_ForbiddenAndRequired(self):
        ...
        # test only in forbidden area
        self.assertFalse(trigger.IsInPosition(restrictions, 12, 10))
        self.assertFalse(trigger.IsInPosition(restrictions, 11, 11))
        self.assertFalse(trigger.IsInPosition(restrictions, 11, 9))
