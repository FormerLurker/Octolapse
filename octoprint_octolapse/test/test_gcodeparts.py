...
class Test_GcodeParts(unittest.TestCase):
	...
	def test_WhitespaceAndComment(self):
		...
		gcodeParts = GcodeParts("			;Here is a comment preceeded by spaces and tabs.")
		self.assertTrue(gcodeParts.Command is None)
		self.assertTrue(gcodeParts.Comment == "Here is a comment preceeded by spaces and tabs.")
		self.assertTrue(len(gcodeParts.Parameters) == 0)
	...
	def test_CommandOnlyWhitespaceAfter(self):
		...
		self.assertTrue(gcodeParts.Command == "THECOMMANDWITHTABSANDSPACESAFTER")
		self.assertTrue(gcodeParts.Comment is None)
		self.assertTrue(len(gcodeParts.Parameters) == 0)
	...
	def test_CommandOnlyWhitespaceBeforeAndAfter(self):
		...
		gcodeParts = GcodeParts("		  THECOMMANDWITHTABSANDSPACESBEFOREANDAFTER		     ")
		self.assertTrue(gcodeParts.Command == "THECOMMANDWITHTABSANDSPACESBEFOREANDAFTER")
		self.assertTrue(gcodeParts.Comment is None)
		self.assertTrue(len(gcodeParts.Parameters) == 0)
	...
	def test_CommandParametersAndComment(self):
		...
		gcodeParts = GcodeParts("THECOMMAND param1 param2 param3 param4;The Comment")
		self.assertTrue(gcodeParts.Command == "THECOMMAND")
		self.assertTrue(gcodeParts.Comment == "The Comment")
		self.assertTrue(len(gcodeParts.Parameters) == 4)
		self.assertTrue(gcodeParts.Parameters[0] == "param1")
	...
	def test_gcode(self):
		...
		gcodeParts = GcodeParts("	THECOMMAND		param1   param2  param3 param4		;   The Comment")
		self.assertTrue(gcodeParts.Gcode == "	THECOMMAND		param1   param2  param3 param4		;   The Comment")
