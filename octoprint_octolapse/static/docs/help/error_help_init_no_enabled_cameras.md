Octolapse requires at least one enabled camera to function.  Make sure you have created at least one camera profile, and that at least one camera profile is enabled.
