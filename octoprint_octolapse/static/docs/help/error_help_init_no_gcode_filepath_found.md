Octolapse was unable to find the gcode file at the location specified by OctoPrint.  This is most likely due to a programming error, or possibly due to an incompatible version of OctoPrint.
