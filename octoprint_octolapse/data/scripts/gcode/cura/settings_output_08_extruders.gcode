...
; Note - This script will only work in Cura V4.1 and below!
; --- Global Settings
...
; max_feedrate_z_override_0 = {max_feedrate_z_override, 0}
; max_feedrate_z_override_1 = {max_feedrate_z_override, 1}
; max_feedrate_z_override_2 = {max_feedrate_z_override, 2}
; max_feedrate_z_override_3 = {max_feedrate_z_override, 3}
; max_feedrate_z_override_4 = {max_feedrate_z_override, 4}
; max_feedrate_z_override_5 = {max_feedrate_z_override, 5}
; max_feedrate_z_override_6 = {max_feedrate_z_override, 6}
; max_feedrate_z_override_7 = {max_feedrate_z_override, 7}
