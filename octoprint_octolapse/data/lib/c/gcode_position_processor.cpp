...
static bool ParseStabilizationArgs_SmartGcode(PyObject* py_args, smart_gcode_args* args)
{
  ...
  {
    std::string message =
      "ParseStabilizationArgs_SmartGcode - Unable to retrieve snapshot_command from the smart gcode trigger stabilization args.";
    octolapse_log_exception(octolapse_log::SNAPSHOT_PLAN, message);
    return false;
  }
  ...
  {
    std::string message =
      "ParseStabilizationArgs_SmartGcode - No alternative snapshot command was provided, using default command only.";
