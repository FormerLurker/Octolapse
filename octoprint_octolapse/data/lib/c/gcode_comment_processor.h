...
public:
	...
	enum section_type { no_section, outer_perimeter_section, inner_perimeter_section, infill_section, skirt_section, solid_infill_section, ooze_shield_section, prime_pillar_section };
