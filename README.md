...
Currently Ocotlapse is not listed in the [plugin repository](https://plugins.octoprint.org/), but can be installed either manually or via the bundled [Plugin Manager](https://github.com/foosel/OctoPrint/wiki/Plugin:-Plugin-Manager).
